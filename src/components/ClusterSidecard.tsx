                            ...
                            <Plot
                              ...
                              layout={{
                                ...
                                shapes: [
                                  ...
                                  // Red gradient from top-left corner (radiating down like sun)
                                  // Create multiple overlapping shapes to simulate gradient from very red to white
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.4,1 L 0,0.6 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                  ...
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.35,1 L 0,0.65 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                  ...
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.25,1 L 0,0.75 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                  ...
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.2,1 L 0,0.8 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(254, 202, 202, 0.15)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.15,1 L 0,0.85 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(254, 226, 226, 0.1)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  {
                                    type: 'path',
                                    path: 'M 0,1 L 0.1,1 L 0,0.9 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(254, 242, 242, 0.05)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  // Green gradient from top-right corner (radiating down like sun)
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.6,1 L 1,0.6 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(5, 150, 105, 0.5)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.65,1 L 1,0.65 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                  ...
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.75,1 L 1,0.75 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                  ...
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.8,1 L 1,0.8 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(167, 243, 208, 0.15)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.85,1 L 1,0.85 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(209, 250, 229, 0.1)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                  {
                                    type: 'path',
                                    path: 'M 1,1 L 0.9,1 L 1,0.9 Z',
                                    xref: 'paper',
                                    yref: 'paper',
                                    fillcolor: 'rgba(236, 253, 245, 0.05)',
                                    line: { width: 0 },
                                    layer: 'below',
                                  },
                                ],
