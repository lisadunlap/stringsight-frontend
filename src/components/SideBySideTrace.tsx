    ...
    <Box>
      ...
      <Box sx={{
        ...
        <Box>
          <ConversationTrace
            messages={messagesA}
            highlights={targetModel && targetModel !== modelA ? [] : highlights}
            rawResponse={rawResponseA}
            modelName={modelA}
            score={scoreA}
          />
        </Box>
        <Box>
          <ConversationTrace
            messages={messagesB}
            highlights={targetModel && targetModel !== modelB ? [] : highlights}
            rawResponse={rawResponseB}
            modelName={modelB}
            score={scoreB}
          />
        </Box>
